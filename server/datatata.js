...
// Connection URI, replace 'your-mongodb-connection-string' with your actual connection string
...
async function insertProducts() {
    ...
    try {
        ...
        const database = client.db('ecommerce'); // Replace with your actual database name
        const collection = database.collection('products'); // Replace with your actual collection name

        // Insert each product into the collection with a new ObjectId
        for (const product of products) {
            product._id = new ObjectId();
            await collection.insertOne(product);
            console.log(`Product inserted successfully with _id: ${product._id}`);
        }
